...
var file_model_book_proto_rawDesc = []byte{
	...
	0x12, 0x1f, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x52, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x2a, 0x3c, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x61, 0x73, 0x79, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x70, 0x69, 0x72, 0x69, 0x74, 0x75,
	0x61, 0x6c, 0x10, 0x03, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x62,
...
var file_model_book_proto_goTypes = []any{
...
func file_model_book_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_model_book_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Book); i {
			case 0:
				return &v.state
			case 1:
		...
		file_model_book_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Author); i {
			case 0:
				return &v.state
			case 1:
